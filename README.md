...
- 🔭 **I’m currently working on:**
  - My PhD research on adaptive, multi-agent AI systems.
  - Publishing a systematic review on AI models for aquatic safety.
  - A comparative analysis of XAI techniques (SHAP, LIME, Grad-CAM) for autonomous systems.
  - Developing a serverless Voice AI for client qualification using AWS Bedrock, Lambda, and Twilio.

- 🌱 **I’m currently learning:**
  - Advanced reinforcement learning for adaptive agent control.
  - Low-latency MLOps pipelines for real-time inference.
  - Formal methods for ensuring AI safety and verification.
...
- 💬 **Ask me about:**
  ...
  - Python for cloud automation, data science, and backend development. 🐍
  - Linux & Open Source—a Debian fan since my early teens! 💻
  - Dungeons & Dragons—happy to discuss campaign crafting or character builds. 🎲
  - Why being an achievement-oriented Slytherin is a feature, not a bug. 🐍

- 📫 **How to reach me:**
  - **g.paduacarvalho@griffith.edu.au** / Discord: **gabriel.ipcarvalho**
